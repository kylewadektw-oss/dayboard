...
async function main() {
  ...
  if (tableExists) {
    ...
    console.log('🔗 Visit: https://supabase.com/dashboard/project/csbwewirwzeitavhvykr/editor');
    console.log('💾 Run the SQL from: supabase/migrations/20250906001000_add_application_logs.sql');
  }
}
