...
async function runPerformanceDiagnostics() {
  try {
    ...
    if (regularError) {
      ...
      console.log(`✅ Regular retrieved ${regularProfiles?.length || 0} profiles`);
    }
    ...
    if (profileDuration > 50) {
      ...
      console.log('   → Consider connection pooling for high-frequency queries');
    }
    ...
    console.log('2. 🔥 HIGH: Implement profile caching (771k queries is excessive)');
