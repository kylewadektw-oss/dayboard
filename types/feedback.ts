...
export type FeedbackType = 'bug' | 'feature_request' | 'improvement' | 'complaint' | 'compliment' | 'other';

export type FeedbackPriority = 'low' | 'medium' | 'high' | 'urgent';

export type FeedbackStatus = 'submitted' | 'in_review' | 'responded' | 'closed' | 'open';
...
export const FEEDBACK_TYPES: { value: FeedbackType; label: string; icon: string; color: string }[] = [
  { value: 'bug', label: 'Bug Report', icon: '🐛', color: 'text-red-600 bg-red-50' },
  { value: 'feature_request', label: 'Feature Request', icon: '💡', color: 'text-blue-600 bg-blue-50' },
  { value: 'improvement', label: 'Improvement', icon: '⚡', color: 'text-yellow-600 bg-yellow-50' },
  { value: 'complaint', label: 'Complaint', icon: '😞', color: 'text-orange-600 bg-orange-50' },
  { value: 'compliment', label: 'Compliment', icon: '👍', color: 'text-green-600 bg-green-50' },
  { value: 'other', label: 'Other', icon: '💭', color: 'text-gray-600 bg-gray-50' },
];
...
export const FEEDBACK_STATUSES: { value: FeedbackStatus; label: string; color: string }[] = [
  ...
  { value: 'in_review', label: 'In Review', color: 'text-yellow-600 bg-yellow-100' },
