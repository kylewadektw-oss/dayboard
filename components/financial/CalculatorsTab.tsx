              ...
              <Card className={isActive ? 'bg-blue-50' : ''}>
                <CardHeader>
                  <div className="flex items-center gap-3">
                    <div
                      className={`p-3 rounded-lg ${getColorClasses(calc.color)}`}
                    >
                    ...
                    <div className="space-y-4">
                      ...
                      {calc.id === 'savings' && (
                        <div className="space-y-3">
                          ...
                          <Button className="w-full">Calculate Growth</Button>
                          <div className="p-3 bg-blue-50 rounded-lg">
                            <p className="text-sm text-blue-700">
                              Future Value:{' '}
                              <span className="font-semibold">$75,420</span>
                            </p>
                          </div>
                        </div>
                      )}
                      ...
                      {calc.id !== 'mortgage' && calc.id !== 'savings' && (
                        <div className="text-center py-8">
                          ...
                          <p className="text-sm text-gray-400">
                            Advanced {calc.title.toLowerCase()} features
                          </p>
                        </div>
                      )}
                    </div>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-sm text-green-700">
                Start with the emergency fund before investing. Aim for 3-6
                months of expenses.
              </p>
            </div>
            ...
            <div className="p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-sm text-purple-700">
                Dollar-cost averaging helps reduce the impact of market
