                  ...
                  <div className="relative group">
                    <div className="flex items-center mb-1">
                      <span className="text-sm">
                        {day.meals.breakfast.recipe?.image_emoji || '🌅'}
                      </span>
                      ...
                      <button
                        onClick={() =>
                          removeMealFromPlan(day.meals.breakfast!.id)
                        }
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-lg p-3 hover:border-yellow-300 transition-colors">
                {day.meals.lunch ? (
                  <div className="relative group">
                    <div className="flex items-center mb-1">
                      <span className="text-sm">
                        {day.meals.lunch.recipe?.image_emoji || '☀️'}
                      </span>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-lg p-3 hover:border-purple-300 transition-colors">
                {day.meals.dinner ? (
                  <div className="relative group">
                    <div className="flex items-center mb-1">
                      <span className="text-sm">
                        {day.meals.dinner.recipe?.image_emoji || '🌙'}
                      </span>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-blue-700">
              {plannedMeals} out of {totalMeals} meals planned (
              {Math.round((plannedMeals / totalMeals) * 100)}% complete)
            </p>
          </div>
