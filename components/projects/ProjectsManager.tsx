...
/*
 * 📋 PROJECTS MANAGER TYPES - Type Definitions
 * 
 * PURPOSE: TypeScript type definitions for projects manager data structures
 * 
 * TYPES:
 ...
 * USAGE:
 * ```typescript
 * import type { TypeName } from '@/types/ProjectsManager';
 * 
...
import { Play, Pause, Calendar, Clock, ChevronLeft, ChevronRight, 
         Plus, Filter, Grid3X3, List, CheckCircle, Circle, 
         Timer, Target, TrendingUp, User, Users } from 'lucide-react';
...
const mockProjects: Project[] = [
  {
    ...
    tasks: [
      ...
      { id: 't3', title: 'Get final quotes', completed: false, dueDate: '2024-12-10' },
      { id: 't4', title: 'Order materials', completed: false, dueDate: '2024-12-15' }
    ]
  },
  {
    id: 'p2',
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 't11', title: 'Prepare presentation', completed: false, dueDate: '2024-12-10' },
      { id: 't12', title: 'Practice presentation', completed: false, dueDate: '2024-12-11' }
    ]
  },
  {
    id: 'p4',
...
export function ProjectsManager() {
  ...
  const prevSlide = () => {
    setCurrentIndex(prev => prev > 0 ? prev - 1 : Math.max(0, filteredProjects.length - 3));
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Track family projects, goals, and time spent</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                {formatTime(projects.reduce((total, p) => total + p.timeSpent, 0))}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                {Math.round(projects.reduce((total, p) => total + p.progress, 0) / projects.length)}%
              </p>
            </div>
          </div>
        </div>
      ...
      {viewMode === 'tiles' ? (
        <div className="relative">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={nextSlide}
              disabled={currentIndex >= Math.max(0, filteredProjects.length - 3)}
              className="p-2 rounded-lg bg-white shadow-sm border border-gray-200 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50"
            >
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1 text-sm text-gray-600">
                      {project.assignee === 'Both' ? <Users className="h-4 w-4" /> : <User className="h-4 w-4" />}
                      {project.assignee}
                    </div>
                  </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wide mb-1">Time Spent</p>
                      <p className="text-sm font-medium">{formatTime(project.timeSpent)} / {formatTime(project.estimatedTime)}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        {project.assignee === 'Both' ? <Users className="h-4 w-4" /> : <User className="h-4 w-4" />}
                        <span className="text-sm font-medium">{project.assignee}</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {activeTimerProject === project.id && (
                        <div className="flex items-center gap-2 bg-green-100 text-green-700 rounded-lg px-3 py-1.5">
                          ...
                          <span className="font-mono">{formatTimerTime(currentTime)}</span>
