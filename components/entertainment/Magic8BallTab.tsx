    ...
    <div className="max-w-2xl mx-auto">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          Ask the mystical Magic 8-Ball any question and get an answer from the
          beyond!
        </p>
      </div>
      ...
      <div className="mt-8 bg-gray-50 rounded-xl p-6">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          <div className="flex items-start gap-2">
            ...
            <span>
              Think of a yes/no question or use &quot;Surprise Me!&quot; for
              random questions
            </span>
          </div>
          <div className="flex items-start gap-2">
            ...
            <span>
              Click &quot;Shake the Ball!&quot; or physically shake your mobile
              device
            </span>
          </div>
          <div className="flex items-start gap-2">
            ...
            <span>
              Watch the magic happen and receive your mystical answer!
            </span>
          </div>
          <div className="flex items-start gap-2">
        ...
        <div className="mt-4 p-3 bg-blue-50 rounded-lg">
          <div className="text-sm text-blue-800">
            <strong>💡 Tip:</strong> Try different themes for different
            experiences! Each theme has unique answers and visual styles.
          </div>
        </div>
      </div>
    </div>
