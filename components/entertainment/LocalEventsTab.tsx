...
const upcomingEvents = [
  {
    ...
    price: 'Free',
    description:
      'Annual spring celebration with live music, food vendors, and family activities.',
    attendees: 250,
    emoji: '🌸',
  ...
  },
  {
    ...
    price: 'Free Entry',
    description:
      'Fresh produce, artisanal goods, and local crafts from community vendors.',
    attendees: 150,
    emoji: '🥕',
  ...
  },
  {
    ...
    price: '$15 per child',
    description:
      'Creative art session for children ages 5-12 with professional instructors.',
    attendees: 24,
    emoji: '🎨',
  ...
  },
  {
    ...
    description:
      'Over 20 gourmet food trucks featuring cuisines from around the world.',
    attendees: 400,
    emoji: '🚚',
...
export const LocalEventsTab = memo(() => {
  const [activeSection, setActiveSection] = useState<
    'discover' | 'categories' | 'saved' | 'featured'
  >('discover');
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <button
              key={suggestion.name}
              className="text-left p-3 bg-white rounded-lg border hover:shadow-md transition-shadow"
            >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              Get notified about new featured events and community happenings in
              your area
            </p>
          </div>
        </div>
        ...
        {sections.map((section) => {
          ...
          return (
            <button
              ...
              onClick={() =>
                setActiveSection(
                  section.id as 'discover' | 'categories' | 'saved' | 'featured'
                )
              }
