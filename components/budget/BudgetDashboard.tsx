...
import type { BudgetCategory, SavingsGoal, BudgetInsight } from '@/types/budget';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">September 2025 • {daysRemaining} days remaining</p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {currentPeriod.categories.slice(0, 6).map((category: BudgetCategory) => {
