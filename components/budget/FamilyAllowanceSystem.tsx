...
const FamilyAllowanceSystem = () => {
  ...
  const getChildAccount = (childId: string) => {
    return allowanceAccounts.find(
      (account) => account.householdMemberId === childId
    );
  };
  ...
  const handleEarnPoints = (choreId: string, points: number) => {
    ...
    const newTransaction: AllowanceTransaction = {
      ...
      amount: points * 0.5, // 50 cents per point
      type: 'earned',
  ...
  const handleSpendReward = (rewardId: string, amount: number) => {
    ...
    setAllowanceAccounts((accounts) =>
      accounts.map((account) => {
        if (
          account.householdMemberId === selectedChild &&
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Track chores, earnings, and teach financial responsibility
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {mockRewards.map((reward) => {
                ...
                return (
                  <div
                    key={reward.id}
                    className={`border rounded-lg p-4 ${canAfford ? 'hover:bg-green-50' : 'opacity-60'}`}
                  >
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <p className="text-sm font-semibold mb-3">
                      Cost:{' '}
                      <span className="text-purple-600">${reward.cost}</span>
                    </p>
                    <Button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                &quot;Save some money from every allowance to reach your bigger
                goals faster!&quot;
              </p>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-sm text-green-700">
                &quot;Complete chores consistently to build good habits and earn
                more!&quot;
              </p>
            </div>
            <div className="p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-sm text-purple-700">
                &quot;Think before you spend - is this something you really want
                or need?&quot;
              </p>
            </div>
          </div>
