...
const FinancialGoalsTracker = () => {
  const [savingsGoals, setSavingsGoals] =
    useState<SavingsGoal[]>(mockSavingsGoals);
  const [showCreateForm, setShowCreateForm] = useState(false);
  const [viewMode, setViewMode] = useState<'all' | 'personal' | 'family'>(
    'all'
  );
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Set, track, and achieve your family&apos;s financial dreams
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredGoals.map((goal) => {
          ...
          const categoryColor =
            goalCategoryColors[goal.category] || 'bg-gray-500';
          const member = mockHouseholdMembers.find(
            (m) => m.id === goal.householdMemberId
          );
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <div
                      className={`w-10 h-10 ${categoryColor} rounded-lg flex items-center justify-center`}
                    >
