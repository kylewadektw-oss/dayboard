...
export function SettingsIntegrationExample() {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow">
      <h3 className="text-lg font-semibold mb-4">Settings Integration Example</h3>
      ...
      <div className="space-y-4">
        ...
        <div className="pt-4 border-t">
          <p className="text-sm text-gray-600">
            These settings are automatically synced with your Supabase profile and 
            persist across sessions. The settings context makes it easy to use 
