...
/*
 * 📋 CALENDAR WIDGET TYPES - Type Definitions
 * 
 * PURPOSE: TypeScript type definitions for calendar widget data structures
 * 
 * TYPES:
 ...
 * USAGE:
 * ```typescript
 * import type { TypeName } from '@/types/CalendarWidget';
 * 
