...
/*
 * 📋 GROCERY WIDGET TYPES - Type Definitions
 * 
 * PURPOSE: TypeScript type definitions for grocery widget data structures
 * 
 * TYPES:
 ...
 * USAGE:
 * ```typescript
 * import type { TypeName } from '@/types/GroceryWidget';
 * 
