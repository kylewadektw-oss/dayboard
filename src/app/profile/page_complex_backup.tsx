  ...
  useEffect(() => {
    ...
    const initializeProfile = async () => {
      try {
        ...
        // Minimal delay to prevent request flooding
        await new Promise(resolve => setTimeout(resolve, 200));
        
        if (!mountedRef.current) return;

        // Single profile fetch with proper error handling
    ...
    // Debounce initialization to prevent rapid re-executions
    const timeoutId = setTimeout(initializeProfile, 100);
