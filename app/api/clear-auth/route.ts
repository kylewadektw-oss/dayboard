...
export async function GET() {
  try {
    ...
    console.log(`🧹 [CLEAR-AUTH] Clearing ${cookiesToClear.length} cookie types with multiple configurations`);
    ...
    console.log('✅ [CLEAR-AUTH] Aggressive cookie clearing complete, redirecting to signin');
