...
export const metadata: Metadata = {
  ...
  description:
    'Cookie Policy for Dayboard™ Family Management Platform by BentLo Labs LLC.',
  openGraph: {
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4 text-gray-700">
                <li>
                  ...
                  features like login and security
                </li>
                <li>
                  <strong>Performance:</strong> To understand how you use our
                  service and identify improvements
                </li>
                <li>
                ...
                <li>
                  <strong>Analytics:</strong> To measure usage patterns and
            ...
            <section className="mb-8">
              ...
              <div className="mb-6">
                ...
                <div className="bg-blue-50 p-4 rounded-lg mb-4">
                  <p className="text-gray-700 mb-2">
                    <strong>Purpose:</strong> Required for basic functionality
                  </p>
                  <p className="text-gray-700 mb-2">
                    <strong>Examples:</strong> Authentication, security, session
                    management
                  </p>
              ...
              <div className="mb-6">
                ...
                <div className="bg-green-50 p-4 rounded-lg mb-4">
                  <p className="text-gray-700 mb-2">
                    <strong>Purpose:</strong> Understand usage patterns and
                    improve performance
                  </p>
                  <p className="text-gray-700 mb-2">
              ...
              <div className="mb-6">
                ...
                <div className="bg-purple-50 p-4 rounded-lg mb-4">
                  ...
                  <p className="text-gray-700 mb-2">
                    <strong>Examples:</strong> Language, theme, dashboard layout
                  </p>
                  <p className="text-gray-700">
              ...
              <div className="mb-6">
                ...
                <div className="bg-orange-50 p-4 rounded-lg mb-4">
                  <p className="text-gray-700 mb-2">
                    <strong>Purpose:</strong> Measure effectiveness of marketing
                    campaigns
                  </p>
                  <p className="text-gray-700 mb-2">
                    <strong>Examples:</strong> Conversion tracking, referral
                    source
                  </p>
                  <p className="text-gray-700">
                    <strong>Can be disabled:</strong> Yes - will not affect core
                    functionality
                  </p>
                </div>
              </div>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4 text-gray-700">
                ...
                <li>
                  <strong>Stripe:</strong> For payment processing (when
                  applicable)
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-700">
                ...
                <li>
                  <strong>Firefox:</strong> Preferences &gt; Privacy &amp;
                  Security &gt; Cookies
                </li>
                <li>
              ...
              <div className="bg-blue-50 p-4 rounded-lg mb-4">
                <p className="text-gray-700 mb-2">
                  <strong>Cookie Preference Center:</strong> Visit your account
                  settings to manage cookie preferences for analytics and
                  marketing cookies.
                </p>
                <p className="text-gray-700">
                  <strong>Note:</strong> Essential cookies cannot be disabled as
                  they are required for core functionality.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                <strong>Children Under 13:</strong> When providing services
                through daycare partnerships:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
                <li>
                  We obtain parental consent before setting cookies for children
                  under 13
                </li>
                <li>We limit tracking to essential functionality only</li>
                <li>Parents can request deletion of all tracking data</li>
                <li>
                  We do not use marketing cookies for children&apos;s accounts
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                <strong>For EU Users:</strong> We comply with GDPR requirements
                for cookies:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
                ...
                <li>
                  We provide clear information about each cookie&apos;s purpose
                </li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4 text-gray-700">
                <li>
                  <strong>Encryption:</strong> Sensitive cookies are encrypted
                  in transit and storage
                </li>
                <li>
                  <strong>Secure Flags:</strong> Cookies are marked as secure
                  and httpOnly when appropriate
                </li>
                <li>
                  <strong>Expiration:</strong> All cookies have appropriate
                  expiration times
                </li>
                <li>
                  <strong>Domain Restrictions:</strong> Cookies are limited to
                  our domain only
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                of significant changes and update the effective date above.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                For questions about our use of cookies or to exercise your
