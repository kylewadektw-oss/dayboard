...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Dayboard™ Family Management Platform by BentLo Labs LLC.',
  openGraph: {
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                BentLo Labs LLC (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) operates Dayboard™, a family management platform. 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                <strong>We do not sell your personal information.</strong> We may share your information in the following limited circumstances:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
                <li><strong>Within Your Household:</strong> Information is shared among household members you invite</li>
                <li><strong>Service Providers:</strong> With trusted partners who help us operate the service (hosting, payments, analytics)</li>
                <li><strong>Legal Requirements:</strong> When required by law or to protect our rights</li>
                <li><strong>Daycare Partners:</strong> Limited information sharing for educational institution features</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                <strong>Protection of Children Under 13:</strong> When providing services through daycare partnerships, 
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">6. Educational Records (FERPA Compliance)</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                <strong>Student Privacy:</strong> For educational institution partnerships, we maintain compliance 
                with the Family Educational Rights and Privacy Act (FERPA).
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
                <li>Educational records are kept confidential and secure</li>
                <li>Parents have the right to access their child&apos;s records</li>
                <li>We obtain consent before sharing educational information</li>
                <li>Records are retained according to institutional policies</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong>GDPR Compliance:</strong> For users in the European Union, we ensure adequate protection 
                for international data transfers and provide rights under the General Data Protection Regulation.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                by email and by posting the updated policy on our website with a new effective date.
              </p>
            </section>
