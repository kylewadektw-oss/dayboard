        ...
        <div className="p-6 max-w-full mx-auto bg-gray-50 min-h-screen">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Comprehensive accessibility monitoring, WCAG compliance, and
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <div
                className={`text-3xl font-bold mb-2 ${getScoreColor(mockData.overallScore)}`}
              >
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <div
                className={`text-3xl font-bold mb-2 ${getScoreColor(mockData.wcagCompliance)}`}
              >
                {mockData.wcagCompliance}%
              </div>
              <div
                className={`text-sm ${getComplianceLevel(mockData.wcagCompliance).color}`}
              >
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <div
                className={`text-3xl font-bold mb-2 ${getScoreColor(mockData.altTextCoverage)}`}
              >
          ...
          <div className="bg-white rounded-lg shadow-sm border mb-6 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">
              📋 WCAG 2.1 Principles Performance
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getScoreColor(mockData.wcagCriteria.perceivable)}`}
                >
              ...
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getScoreColor(mockData.wcagCriteria.operable)}`}
                >
              ...
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getScoreColor(mockData.wcagCriteria.understandable)}`}
                >
              ...
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getScoreColor(mockData.wcagCriteria.robust)}`}
                >
              ...
              {activeTab === 'overview' && (
                <div className="space-y-6">
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-600">
                                {issue.element} -{' '}
                                {issue.issue ||
                                  `${issue.ratio} (needs ${issue.required})`}
                              </div>
                            </div>
                          </div>
                  ...
                  <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                    ...
                    <p className="text-gray-600">
                      Comprehensive accessibility monitoring with real-time
              ...
              {activeTab === 'wcag' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                    ...
                    <p className="text-gray-600">
                      Detailed success criteria analysis and compliance gap
                      identification with remediation roadmaps.
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
                    ...
                    <p className="text-gray-600 max-w-md mx-auto">
                      Automated testing with axe-core, WAVE, and custom
                      accessibility validators for comprehensive coverage.
                    </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-purple-50 p-4 rounded-lg text-center">
                      <div
                        className={`text-2xl font-bold ${getScoreColor(mockData.assistiveTech.screenReaders)}`}
                      >
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg text-center">
                      <div
                        className={`text-2xl font-bold ${getScoreColor(mockData.assistiveTech.voiceControl)}`}
                      >
                    ...
                    <div className="bg-green-50 p-4 rounded-lg text-center">
                      <div
                        className={`text-2xl font-bold ${getScoreColor(mockData.assistiveTech.switchNavigation)}`}
                      >
                    ...
                    <div className="bg-orange-50 p-4 rounded-lg text-center">
                      <div
                        className={`text-2xl font-bold ${getScoreColor(mockData.assistiveTech.magnification)}`}
                      >
                  ...
                  <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                    ...
                    <p className="text-gray-600">
                      Compatibility testing with JAWS, NVDA, VoiceOver, Dragon,
              ...
              {activeTab === 'users' && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-gray-50 p-4 rounded-lg text-center">
                      <div className="text-2xl font-bold text-gray-900">
                        {mockData.userPreferences.highContrast}%
                      </div>
                      <div className="text-sm text-gray-600">High Contrast</div>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-lg text-center">
                      <div className="text-2xl font-bold text-gray-900">
                        {mockData.userPreferences.largeText}%
                      </div>
                      <div className="text-sm text-gray-600">Large Text</div>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-lg text-center">
                      <div className="text-2xl font-bold text-gray-900">
                        {mockData.userPreferences.reducedMotion}%
                      </div>
                      <div className="text-sm text-gray-600">
                        Reduced Motion
                      </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg text-center">
                      <div className="text-2xl font-bold text-gray-900">
                        {mockData.userPreferences.screenReader}%
                      </div>
                  ...
                  <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                    ...
                    <p className="text-gray-600">
                      User preference tracking and adaptive interface
                      performance for personalized accessibility experiences.
                    </p>
                  </div>
                </div>
              )}
