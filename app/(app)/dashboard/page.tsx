    ...
    <ProtectedRoute requireAuth={true}>
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Main Dashboard Grid - Improved Loading Strategy */}
          <div className="space-y-6">
            {/* Row 1 - Primary Widgets - Show weather skeleton immediately */}
                ...
                <Suspense fallback={
                  <div className="bg-white rounded-2xl shadow-lg p-4 h-full">
                    <div className="animate-pulse">
                      ...
                      <div className="text-xs text-blue-600 mb-4">🔄 Loading weather...</div>
