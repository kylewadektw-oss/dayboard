...
/*
 * 🛠️ SERVER UTILITY - Helper Functions
 * 
 * PURPOSE: Utility functions and helpers for server functionality
 * 
 * EXPORTS:
 ...
 * USAGE:
 * ```typescript
 * import { functionName } from '@/utils/server';
 * 
...
export async function signInWithEmail(formData: FormData) {
  ...
  if (error) {
    ...
    // TODO: Fix cookie setting for Next.js 15
