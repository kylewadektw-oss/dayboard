  ...
  setInterval(() => {
    if (window.outerHeight - window.innerHeight > 200 || 
      ...
      if (!devtools.open) {
        devtools.open = true;
        console.clear();
        console.log('%c🛡️ DAYBOARD PROPRIETARY CODE', 'color: red; font-size: 20px; font-weight: bold;');
        console.log('%cUnauthorized code inspection is prohibited!', 'color: red; font-size: 16px;');
        console.log('%cLarge corporations copying this code may face legal action.', 'color: orange; font-size: 14px;');
        console.log('%cContact licensing@dayboard.com for commercial use.', 'color: blue; font-size: 14px;');
...
export function addOwnershipWatermark() {
  ...
  // Add to console
  console.log('%c🛡️ Dayboard © 2025 Kyle Wade', 'color: #666; font-size: 12px;');
  console.log('%cThis is proprietary software. Unauthorized copying prohibited.', 'color: #666; font-size: 10px;');
}
